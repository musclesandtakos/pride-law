...
import { BriefcaseBusiness, CalendarDays, CheckSquare2, CircleDollarSign, ContactRound, FileText, FileType2, Gauge, History, Inbox, Timer, TrendingUp, UsersRound } from "lucide-react";
...
const groups=[
  ...
  {label:"Administration",items:[["/users","Users",UsersRound],["/audit","Audit log",History]]},
] as const;
